...
CATEGORY_MAPPING = {
    ...
    'tresemme_hf_def': 'haircare',
    'tresemme_ks_cond': 'haircare',
    ...
    'gl_bb_crm': 'skincare',
    'gl_bright_glow_fw': 'skincare',
    'gl_mltvit_crm': 'skincare',
    'gl_sunscrn_crm': 'skincare',
    'ponds_bright_beauty_crm': 'skincare',
    'ponds_bright_beauty_fw': 'skincare',
    'ponds_detox_fw': 'skincare',
    'ponds_mineral_clay_ff': 'skincare',
    'ponds_mineral_clay_scb': 'skincare',
    'ponds_oil_control_fw': 'skincare',
    'dove_hg': 'skincare',
    'dove_mask_25': 'skincare',
    'dove_no': 'skincare',
    'dove_oxg': 'skincare',
    'lux_blk_orchd': 'skincare',
    'lux_freeasia_scnt': 'skincare',
    'lux_french_rose': 'skincare',
    'lux_vitamin_c': 'skincare',

    # Home and Hygiene
    'lifebuoy_pump': 'homeandhygiene',
    'lifebuoy_refill': 'homeandhygiene',

    # Food and Nutrition
    'horlicks_choco': 'foodandnutrition',
    'horlicks_junior_s1': 'foodandnutrition',
    'horlicks_junior_s2': 'foodandnutrition',
...
CATEGORY_COLORS = {
    'haircare': (255, 165, 0),      # Orange
    'oralcare': (255, 255, 0),      # Cyan
    'skincare': (255, 192, 203),    # Pink
